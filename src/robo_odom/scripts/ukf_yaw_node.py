...
def UKFinit():
    global ukf
    ukf_fuse = []
    p_std_yaw = rospy.get_param('~p_std_yaw',0.004)
    v_std_yaw = rospy.get_param('~v_std_yaw',0.008)
...
def callback_imu(imu):
    ...
    if IMU_INIT == True:
        ...
        #print ukf.x[0]
        print 'uwb_yaw',uwb_yaw,'fuse_yaw', fuse_yaw,'bais:', uwb_yaw - imu_yaw, 'kalman',ukf_out_yaw, 'accz', vel_imu_yaw
